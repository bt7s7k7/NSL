...
namespace NSL.Runtime
{
    public class ActionBuilder
    {
        ...
        protected VariableDefinition returnVariable;
        protected IEnumerable<VariableDefinition> argumentVariables;
        ...
        public ActionBuilder(Runner.Scope parentScope, VariableDefinition returnVariable, IEnumerable<VariableDefinition> argumentVariables, string actionVarName, Runner.Scope scope)
        {
